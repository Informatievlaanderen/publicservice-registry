      ...
      <div id="vlaanderen-footer-info">
          ...
          <div id="vlaanderen-footer-info-publisher">
            ...
            <span itemprop="publisher" itemscope="" itemtype="http://schema.org/Organization">
              ...
              </a><span id="dvrVersion">Developer versie</span>
            </span>
          </div>
      </div>
    </div>
...
export default {
  ...
  mounted() {
    if(window.dienstverleningVersion) {
      document.getElementById("dvrVersion").innerHTML = ', versie ' + window.dienstverleningVersion;
    } else {
      document.getElementById("dvrVersion").innerHTML = ', developer versie';
    }
  },
};
</script>
