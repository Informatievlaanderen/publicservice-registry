...
$certificate = New-SelfSignedCertificate `
    -Subject dienstverlening-test.basisregisters.vlaanderen `
    -DnsName dienstverlening-test.basisregisters.vlaanderen `
    -KeyAlgorithm RSA `
    -KeyLength 2048 `
    -NotBefore (Get-Date) `
...
$pfxFilePath = "c:\tmp\dienstverlening-test.basisregisters.vlaanderen.pfx"
$cerFilePath = "c:\tmp\dienstverlening-test.basisregisters.vlaanderen.cer"
