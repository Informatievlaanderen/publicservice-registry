...
$certificate = New-SelfSignedCertificate `
    -Subject api.dev.dienstverleningen.basisregisters.vlaanderen.be `
    -DnsName api.dev.dienstverleningen.basisregisters.vlaanderen.be `
    -KeyAlgorithm RSA `
    -KeyLength 2048 `
    -NotBefore (Get-Date) `
...
$pfxFilePath = "c:\tmp\api.dev.dienstverleningen.basisregisters.vlaanderen.be.pfx"
$cerFilePath = "c:\tmp\api.dev.dienstverleningen.basisregisters.vlaanderen.be.cer"
